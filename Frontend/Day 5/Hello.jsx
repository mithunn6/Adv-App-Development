        ...
        <div className="justify-between mx-auto lg:w-full md:items-center md:flex">
          ...
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              {/* Logo section */}
              <Link className="text-3xl text-blue-500 font-semibold tracking-[0.1rem]">
                Golden Years
              </Link>
          ...
          >
            <ul className="list-none lg:flex md:flex sm:block block gap-x-5 gap-y-16">
              ...
              <button className="bg-blue-500 w-35 text-[1.1rem] text-center font-normal text-white px-6 py-1.5 rounded lg:ml-10 md:ml-6 sm:ml-0 ml-0">
              Register     
